...
if __name__ == "__main__":
    ...
    print()
    print(f"add_two(5,5) = {round(add_two(5,5),2)}")
    print()
    print(f"add_triangle_list([5,5,5) = {round(add_triangle_list([5,5,5]),2)}")
    print()
    print(f"add_any(2)       = {round(add_any(2),2)}")
    print(f"add_any(2,2)     = {round(add_any(2,2),2)}")
    print(f"add_any(2,2,2)   = {round(add_any(2,2,2),2)}")
    print(f"add_any(2,2,2,2) = {round(add_any(2,2,2,2),2)}")
    print()
    print(f"add_any_with_keywords(a=8,b=2) = {round(add_any_with_keywords(a=8,b=2),2)}")
    print()
    print("===========================================================")
